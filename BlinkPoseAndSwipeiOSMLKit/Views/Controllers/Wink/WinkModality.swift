...
class WinkModality: UIViewController {
    ...
    let titleLabel: UILabel = {
        ...
        title.text = "Wink Modality for page turning"
    ...
    lazy var practiceButton: UIButton = {
        ...
        button.setTitleColor(UIColor(red: 0.98, green: 0.388, blue: 0.337, alpha: 1), for: .normal)
        button.layer.cornerRadius = 12
        button.layer.borderWidth = 1
        button.layer.borderColor = UIColor(red: 0.98, green: 0.388, blue: 0.337, alpha: 1).cgColor
    ...
    lazy var testButton: UIButton = {
         ...
         button.backgroundColor = UIColor(red: 0.98, green: 0.388, blue: 0.337, alpha: 1)
         button.layer.cornerRadius = 12
